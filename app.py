...
# Halaman Visualisasi Data
    ...
    selected_category = st.sidebar.selectbox("Halaman",
                                             ["Distribusi", "Perbandingan", "Hubungan / Korelasi", "Komposisi"])

    if selected_category == "Distribusi":
        st.subheader("Distribusi Usia Siswa Berdasarkan Tingkat Adaptivitas")
        st.write("**Tingkat Adaptivitas Low (Rendah)**")
        ...
        st.write("")
        st.write("**Tingkat Adaptivitas Moderate (Sedang)**")
        ...
        st.write("")
        st.write("**Tingkat Adaptivitas High (Tinggi)**")
    ...
    elif selected_category == "Perbandingan":
    ...
    elif selected_category == "Hubungan / Korelasi":
